...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CalibrationDataStore.metric'
        db.alter_column(u'core_calibrationdatastore', 'metric_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['core.Metric']))

        # Changing field 'CalibrationDataStore.unit'
        db.alter_column(u'core_calibrationdatastore', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['core.Unit']))

        # Changing field 'CalibrationDataStore.metadata'
        db.alter_column(u'core_calibrationdatastore', 'metadata', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

        # Changing field 'APIDataStore.metric'
        db.alter_column(u'core_apidatastore', 'metric_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['core.Metric']))

        # Changing field 'APIDataStore.unit'
        db.alter_column(u'core_apidatastore', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['core.Unit']))

    def backwards(self, orm):

        # Changing field 'CalibrationDataStore.metric'
        db.alter_column(u'core_calibrationdatastore', 'metric_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Metric']))

        # Changing field 'CalibrationDataStore.unit'
        db.alter_column(u'core_calibrationdatastore', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Unit']))

        # Changing field 'CalibrationDataStore.metadata'
        db.alter_column(u'core_calibrationdatastore', 'metadata', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'APIDataStore.metric'
        db.alter_column(u'core_apidatastore', 'metric_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Metric']))

        # Changing field 'APIDataStore.unit'
        db.alter_column(u'core_apidatastore', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Unit']))
    ...
    models = {
        ...
        u'core.calibrationdatastore': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metadata': ('django.db.models.fields.TextField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
