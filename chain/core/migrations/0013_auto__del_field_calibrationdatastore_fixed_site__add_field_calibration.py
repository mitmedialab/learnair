...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CalibrationDataStore.fixed_site'
        db.delete_column(u'core_calibrationdatastore', 'fixed_site_id')

        # Adding field 'CalibrationDataStore.site'
        db.add_column(u'core_calibrationdatastore', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='calibration_datastore', null=True, to=orm['core.FixedSite']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CalibrationDataStore.fixed_site'
        db.add_column(u'core_calibrationdatastore', 'fixed_site',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='calibration_datastore', null=True, to=orm['core.FixedSite'], blank=True),
                      keep_default=False)

        # Deleting field 'CalibrationDataStore.site'
        db.delete_column(u'core_calibrationdatastore', 'site_id')
