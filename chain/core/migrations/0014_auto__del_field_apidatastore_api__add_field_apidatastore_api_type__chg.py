...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'APIDataStore.api'
        db.delete_column(u'core_apidatastore', 'api_id')

        # Adding field 'APIDataStore.api_type'
        db.add_column(u'core_apidatastore', 'api_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='api_datastore', null=True, to=orm['core.APIType']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'APIDataStore.api'
        db.add_column(u'core_apidatastore', 'api',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='api_datastore', to=orm['core.APIType']),
                      keep_default=False)

        # Deleting field 'APIDataStore.api_type'
        db.delete_column(u'core_apidatastore', 'api_type_id')
    ...
    models = {
        ...
        u'core.apidatastore': {
            ...
            'metric': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'api_datastore'", 'null': 'True', 'to': u"orm['core.Metric']"}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'api_datastore'", 'null': 'True', 'to': u"orm['core.FixedSite']"}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'api_datastore'", 'null': 'True', 'to': u"orm['core.Unit']"})
        },
        u'core.apitype': {
